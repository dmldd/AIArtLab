...
@Service
public class ImageProcessingService2 {
    private static  final Integer  QUEUE_NUM=2;
    @Autowired
    ...
    private void processRequest(QueueWrapper requestWrapper) {
        ...
        if (requestWrapper.getTextToImgIfo() != null) {
            ...
            try {
                ...
                // 向API发送请求，并接收响应
                System.out.println("vae:"+stableDiffusionTextToImg.getOverride_settings().getSd_vae());
        ...
        //图生图
            ...
            try {
                ...
                // 向API发送图生图请求，并接收响应
                System.out.println("steps"+stableDiffusionImg2Img.getSteps()+"vae:"+stableDiffusionImg2Img.getOverride_settings().getSd_vae());
